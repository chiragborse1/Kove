...
Goal: find the one real route from node -> gateway, verify Kova is advertising that route, then fix pairing/auth.
...
If this Kova instance is pointed at a remote gateway, also run:
