...
${formatHelpExamples([
  ...
  [
    'kova agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
    "Send reply to a different channel/target.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.kova.ai/cli/agent")}`,
    )
    .action(async (opts) => {
...
${formatHelpExamples([
  ...
  [
    "kova agents set-identity --identity-file ~/.openclaw/workspace/IDENTITY.md --agent main",
