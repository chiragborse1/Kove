...
homepage: https://docs.kova.ai/automation/hooks#command-logger
metadata:
  {
    "openclaw":
      {
...
2. **Appends to log file** - Writes a JSON line to `~/.kova/logs/commands.log`
...
1. **Manual rotation**:
   ...
   ```bash
   mv ~/.kova/logs/commands.log ~/.kova/logs/commands.log.old
   ```
