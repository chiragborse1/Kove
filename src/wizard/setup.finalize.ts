...
export async function finalizeSetupWizard(
      ...
      await prompter.note(
        [
          ...
          controlUiOpened
            ...
            : "Copy/paste this URL in a browser on this machine to control Kova.",
          controlUiOpenHint,
        ]
          .filter(Boolean)
          .join("\n"),
  ...
  await prompter.note(
    ["Back up your agent workspace.", "Docs: https://docs.kova.ai/concepts/agent-workspace"].join(
      "\n",
    ),
    "Workspace backup",
  );
  ...
  await prompter.note(
    "Running agents on your computer is risky — harden your setup: https://docs.kova.ai/security",
    "Security",
  );
  ...
  await prompter.note(
    'What now: https://kova.ai/showcase ("What People Are Building").',
    "What now",
  );

  await prompter.outro(
    controlUiOpened
      ? "Onboarding complete. Dashboard opened; keep that tab to control Kova."
      : seededInBackground
        ? "Onboarding complete. Web UI seeded in the background; open it anytime with the dashboard link above."
        : "Onboarding complete. Use the dashboard link above to control Kova.",
  );
