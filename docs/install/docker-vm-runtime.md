---
summary: "Shared Docker VM runtime steps for long-lived Kova Gateway hosts"
read_when:
  - You are deploying Kova on a cloud VM with Docker
...
Kova runs in Docker, but Docker is not the source of truth.
