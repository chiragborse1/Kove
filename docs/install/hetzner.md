---
summary: "Run Kova Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want Kova running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running Kova in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# Kova on Hetzner (Docker, Production VPS Guide)

## Goal

Run a persistent Kova Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “Kova 24/7 for ~$5”, this is the simplest reliable setup.
...
- Persist `~/.openclaw` + `~/.kova/workspace` on the host (survives restarts/rebuilds)
