...
`~/.kova/openclaw.json` under `plugins.entries.perplexity.config.webSearch.apiKey`.
...
`~/.kova/.env` (or your service environment). See [Env vars](/help/faq#env-vars-and-env-loading).
