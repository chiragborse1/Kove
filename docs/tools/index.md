---
summary: "Kova tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Kova provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with Kova), others are **external**
...
| `group:nodes`      | nodes                                                                                                     |
| `group:openclaw`   | All built-in Kova tools (excludes plugin tools)                                                       |
