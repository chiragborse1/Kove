...
openclaw agents add work --workspace ~/.kova/workspace-work
openclaw agents set-identity --workspace ~/.kova/workspace --from-identity
...
- 示例路径：`~/.kova/workspace/IDENTITY.md`
...
```bash
openclaw agents set-identity --agent main --name "Kova" --emoji "🦞" --avatar avatars/openclaw.png
```
