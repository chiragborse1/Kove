...
summary: "How to contribute to the Kova threat model"
read_when:
  - You want to contribute security findings or threat scenarios
  - Reviewing or updating the threat model
---

# Contributing to the Kova Threat Model

Thanks for helping make Kova more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- [Kova Threat Model](/security/THREAT-MODEL-ATLAS)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Kova security hall of fame for significant contributions.
