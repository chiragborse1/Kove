...
You can point Kova at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Kova
...
- [Anthropic provider](/providers/anthropic) - Native Kova integration with Claude setup-token or API keys
