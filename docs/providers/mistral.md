---
summary: "Use Mistral models and Voxtral transcription with Kova"
read_when:
  - You want to use Mistral models in Kova
...
Kova supports Mistral for both text/image model routing (`mistral/...`) and
