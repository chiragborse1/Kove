---
summary: "Use Synthetic's Anthropic-compatible API in Kova"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Kova registers it as the
...
Note: Kova's Anthropic client appends `/v1` to the base URL, so use
