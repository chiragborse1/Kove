---
summary: "Use Qianfan's unified API to access many models in Kova"
read_when:
...
3. Kova installed on your system
...
4. Copy the API key for use with Kova
...
- [Kova Configuration](/gateway/configuration)
