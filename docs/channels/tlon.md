...
Tlon is a decentralized messenger built on Urbit. Kova connects to your Urbit ship and can
...
By default, Kova blocks private/internal hostnames and IP ranges for SSRF protection.
...
- Thread replies: if the inbound message is in a thread, Kova replies in-thread.
