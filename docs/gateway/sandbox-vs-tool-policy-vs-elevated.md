...
Kova has three related (but different) controls:
...
Use the inspector to see what Kova is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:openclaw`: all built-in Kova tools (excludes provider plugins)
