...
This page lists every configuration knob for Kova memory search. For
...
Remote embeddings require an API key. Kova resolves from:
...
When sqlite-vec is unavailable, Kova falls back to in-process cosine
