---
summary: "macOS IPC architecture for Kova app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# Kova macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → Kova.app → local execution.
