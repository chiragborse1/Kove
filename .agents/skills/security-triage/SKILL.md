...
description: Triage GitHub security advisories for Kova with high-confidence close/keep decisions, exact tag and commit verification, trust-model checks, optional hardening notes, and a final reply ready to post and copy to clipboard.
---

# Security Triage

Use when reviewing Kova security advisories, drafts, or GHSA reports.
