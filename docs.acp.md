...
This document describes how the Kova ACP (Agent Client Protocol) bridge works,
...
Kova Gateway over WebSocket. It keeps ACP session ids mapped to Gateway
...
runtime. It is designed to route IDE prompts into an existing Kova Gateway
