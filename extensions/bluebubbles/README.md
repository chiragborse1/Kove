...
This package contains the **BlueBubbles external channel plugin** for Kova.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `getkova/plugin-sdk` helpers.
