...
Official Voice Call plugin for **Kova**.
...
Docs: `https://docs.kova.ai/plugins/voice-call`
Plugin system: `https://docs.kova.ai/plugin`

## Install (local dev)

### Option A: install via Kova (recommended)
...
- advanced webhook, streaming, and tunnel notes: `https://docs.kova.ai/plugins/voice-call`

## Stale call reaper

See the plugin docs for recommended ranges and production examples:
`https://docs.kova.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.kova.ai/plugins/voice-call#tts-for-calls`

## CLI

```bash
openclaw voicecall call --to "+15555550123" --message "Hello from Kova"
