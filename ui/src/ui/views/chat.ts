...
function resolveAgentOptions(props: ChatProps) {
  ...
  if (!seen.has(props.currentAgentId)) {
    pushOption(props.currentAgentId, brandDisplayName(props.assistantName) || props.currentAgentId);
  }
  return options;
}
    ...
    >
      ...
      >
        <div style="display: grid; gap: 4px;">
          ...
          <div class="card-sub">
            Choose who replies here and whether that employee speaks their responses aloud.
          </div>
        </div>
