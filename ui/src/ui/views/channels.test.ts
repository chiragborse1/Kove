...
function createProps(snapshot: ChannelsProps["snapshot"]): ChannelsProps {
  return {
    ...
    whatsappBusy: false,
    telegramSetupToken: "",
    telegramSetupBusy: false,
    telegramSetupMessage: null,
    telegramApprovalsLoading: false,
    telegramApprovalsBusyCode: null,
    telegramApprovalsMessage: null,
    telegramPendingApprovals: [],
    configSchema: null,
