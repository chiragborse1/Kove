...
export function renderSkills(props: SkillsProps) {
  ...
  let afterStatus = skills;
  if (props.statusFilter !== "marketplace" && props.statusFilter !== "all") {
    const statusFilter: Exclude<SkillsStatusFilter, "marketplace" | "all"> = props.statusFilter;
    afterStatus = skills.filter((skill) => skillMatchesStatus(skill, statusFilter));
  }
