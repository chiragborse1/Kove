...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    sessions: "All conversations across channels.",
    usage: "Token usage and AI costs.",
    cron: "Schedule your AI team automatically.",
    skills: "Skills and API keys.",
    nodes: "Paired mobile and desktop apps.",
