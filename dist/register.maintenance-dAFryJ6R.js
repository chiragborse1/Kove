import { _ as resolveOAuthDir, a as isNixMode, d as resolveGatewayPort, s as resolveConfigPath, y as resolveStateDir } from "./paths-CG2veZVr.js";
import { n as defaultRuntime } from "./runtime-kS8e4c6-.js";
import { v as resolveHomeDir } from "./utils-CQHEfYrT.js";
...
import { f as resolveControlUiLinks, i as formatControlUiSshHint } from "./onboard-helpers-BPgzEhsc.js";
...
import { a as removePath, i as listAgentSessionDirs, o as removeStateAndLinkedPaths, r as buildCleanupPlan, s as removeWorkspaceDirs } from "./backup-create-CgE8uH63.js";
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	if (resolvedToken.unresolvedRefReason) {
		...
		runtime.log("Set OPENCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `kova dashboard`.");
	}
	...
	if (opened) runtime.log("Opened in your browser. Keep that tab to control Kova.");
