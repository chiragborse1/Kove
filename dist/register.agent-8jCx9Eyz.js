...
import { r as listAgentIds } from "./agent-scope-PYTdAamx.js";
...
import { _ as GATEWAY_CLIENT_NAMES, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES } from "./message-channel-CAdct431.js";
import { c as randomIdempotencyKey, r as callGateway } from "./call-Cmc_PDdk.js";
...
import { r as resolveSessionKeyForRequest, t as agentCommand } from "./agent-command-D7n51Dqp.js";
import { n as runCommandWithRuntime } from "./cli-utils-Ck3m3E7C.js";
import { t as formatHelpExamples } from "./help-format-B6p6tNX6.js";
import "./agent-B4ZIcCZH.js";
import { t as collectOption } from "./helpers-BYrvRb09.js";
import { a as agentsBindCommand, i as agentsAddCommand, n as agentsSetIdentityCommand, o as agentsBindingsCommand, r as agentsDeleteCommand, s as agentsUnbindCommand, t as agentsListCommand } from "./agents-DKM9I03F.js";
...
${formatHelpExamples([
		["kova agent --to +15555550123 --message \"status update\"", "Start a new session."],
		["kova agent --agent ops --message \"Summarize logs\"", "Use a specific agent."],
		["kova agent --session-id 1234 --message \"Summarize inbox\" --thinking medium", "Target a session with explicit thinking level."],
		["kova agent --to +15555550123 --message \"Trace logs\" --verbose on --json", "Enable verbose logging and JSON output."],
		["kova agent --to +15555550123 --message \"Summon reply\" --deliver", "Deliver reply."],
		["kova agent --agent ops --message \"Generate report\" --deliver --reply-channel slack --reply-to \"#reports\"", "Send reply to a different channel/target."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.kova.ai/cli/agent")}`).action(async (opts) => {
...
${formatHelpExamples([
		...
		["kova agents set-identity --workspace ~/.openclaw/workspace --from-identity", "Load from IDENTITY.md."],
		["kova agents set-identity --identity-file ~/.openclaw/workspace/IDENTITY.md --agent main", "Use a specific IDENTITY.md."]
	])}
`).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
