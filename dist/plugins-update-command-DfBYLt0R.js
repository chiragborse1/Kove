...
import { C as shortenHomePath, b as resolveUserPath, t as CONFIG_DIR } from "./utils-CQHEfYrT.js";
import { r as theme } from "./theme-DwswwArY.js";
import { c as loadConfig, f as readConfigFileSnapshot } from "./io-DcGUiGNW.js";
import { n as MANIFEST_KEY } from "./legacy-names-BPkSHTng.js";
...
import { t as promptYesNo } from "./prompt-D1aOMG0p.js";
import { r as parseRegistryNpmSpec } from "./npm-registry-spec-Br0qFt_S.js";
import { a as resolveArchiveKind } from "./archive-OfZ_BuVX.js";
import { t as findBundledPluginSource } from "./bundled-sources-C1OHwWGt.js";
import { t as parseFrontmatter } from "./frontmatter-DnTW0hW9.js";
import { a as resolvePinnedNpmInstallRecordForCli, n as persistPluginInstall, r as recordHookInstall, t as persistHookPackInstall } from "./plugins-install-persist-C8QeTFtJ.js";
import { s as parseClawHubPluginSpec } from "./clawhub-BCircDr8.js";
import { o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-GmCGFU5p.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-DZ-oUtox.js";
import { n as formatClawHubSpecifier, r as installPluginFromClawHub } from "./clawhub-CY_3A-Op.js";
import { a as decidePreferredClawHubFallback, c as extractInstalledNpmPackageName, i as createPluginInstallLogger, l as formatPluginInstallWithHookFallbackError, n as buildPreferredClawHubSpec, r as createHookPackInstallLogger, s as extractInstalledNpmHookPackageName } from "./plugins-command-helpers-2CRL011z.js";
import { r as resolveBundledInstallPlanForNpmFailure, t as resolveBundledInstallPlanBeforeNpm } from "./plugin-install-plan-B-AfORam.js";
import { t as cleanStaleMatrixPluginConfig } from "./matrix-DP2af0VX.js";
import { a as installPluginFromMarketplace, i as readInstalledPackageVersion, n as updateNpmInstalledPlugins, r as expectedIntegrityForUpdate, s as resolveMarketplaceInstallShortcut } from "./update-DWifhaH7.js";
import { r as resolvePluginInstallRequestContext, t as resolvePluginInstallInvalidConfigPolicy } from "./plugin-install-config-policy-Dex1jhIa.js";
...
async function loadHookInstallRuntime() {
	hookInstallRuntimePromise ??= import("./install.runtime-CrRdTcMP.js");
...
async function loadConfigFromSnapshotForInstall(request) {
	if (resolvePluginInstallInvalidConfigPolicy(request) !== "recover-matrix-only") throw buildInvalidPluginInstallConfigError("Config invalid; run `kova doctor --fix` before installing plugins.");
	const snapshot = await readConfigFileSnapshot();
	const parsed = snapshot.parsed ?? {};
	if (!snapshot.exists || Object.keys(parsed).length === 0) throw buildInvalidPluginInstallConfigError("Config file could not be parsed; run `kova doctor` to repair it.");
	if (snapshot.legacyIssues.length > 0 || snapshot.issues.length === 0 || snapshot.issues.some((issue) => !isAllowedMatrixRecoveryIssue(issue))) throw buildInvalidPluginInstallConfigError("Config invalid outside the Matrix upgrade recovery path; run `kova doctor --fix` before reinstalling Matrix.");
