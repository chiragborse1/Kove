...
import { o as resolvePluginSourceRoots } from "./manifest-registry-NzxlUGDZ.js";
import { r as replaceConfigFile } from "./config-Dl06sDj4.js";
import { t as promptYesNo } from "./prompt-D1aOMG0p.js";
import { n as setPluginEnabledInConfig, t as enablePluginInConfig } from "./enable-D6L1I5Sn.js";
import { s as parseClawHubPluginSpec } from "./clawhub-BCircDr8.js";
import { a as buildPluginStatusReport, i as buildPluginInspectReport, n as buildPluginCompatibilityNotices, o as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-C60d7mDK.js";
import { d as logSlotWarnings, i as createPluginInstallLogger, t as applySlotSelectionForPlugin } from "./plugins-command-helpers-2CRL011z.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-DN8e5QIM.js";
import { a as uninstallPlugin, i as resolveUninstallDirectoryTarget, r as resolveUninstallChannelConfigKeys } from "./matrix-DP2af0VX.js";
import { n as runPluginInstallCommand, t as runPluginUpdateCommand } from "./plugins-update-command-DfBYLt0R.js";
import { o as listMarketplacePlugins } from "./update-DWifhaH7.js";
...
function registerPluginsCli(program) {
	const plugins = program.command("plugins").description("Manage Kova plugins and extensions").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "docs.kova.ai/cli/plugins")}\n`);
	...
	plugins.command("doctor").description("Report plugin load issues").action(() => {
		...
		const docs = formatDocsLink("/plugin", "docs.kova.ai/plugin");
		lines.push("");
