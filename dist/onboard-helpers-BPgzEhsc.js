...
import { C as shortenHomePath, S as shortenHomeInString, t as CONFIG_DIR, w as sleep } from "./utils-CQHEfYrT.js";
...
import "./detect-binary-SB25xFXK.js";
import "./browser-open-DE2jOBq5.js";
import { r as stylePromptTitle } from "./prompt-style-738lx6X3.js";
...
function formatControlUiSshHint(params) {
	...
	return [
		...
		authedUrl,
		"Docs:",
		"https://docs.kova.ai/gateway/remote",
		"https://docs.kova.ai/web/control-ui"
	].filter(Boolean).join("\n");
}
