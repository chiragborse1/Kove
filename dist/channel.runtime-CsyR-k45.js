...
import { n as resolveMatrixAuth } from "./config-lPcQQpX9.js";
import "./client-BZTWwJtN.js";
import { n as listMatrixDirectoryGroupsLive, r as listMatrixDirectoryPeersLive, t as resolveMatrixTargets } from "./resolve-targets-DR7b6yAJ.js";
import { a as sendMessageMatrix, o as sendPollMatrix } from "./send-BRgxvnq0.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./client-CGV9Y-TO.js").then((clientModule) => ({ createMatrixClient: clientModule.createMatrixClient }));
