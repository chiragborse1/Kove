...
import { O as promptAccountId, t as addWildcardAllowFrom, v as mergeAllowFromEntries } from "../../setup-wizard-helpers-CiTUqqHq.js";
...
import { s as resolveMatrixAccountConfig, t as resolveMatrixConfigFieldPath } from "../../config-paths-CAwnU3f8.js";
...
import { f as setMatrixThreadBindingMaxAgeBySessionKey, n as getMatrixThreadBindingManager, o as resetMatrixThreadBindingsForTests, u as setMatrixThreadBindingIdleTimeoutBySessionKey } from "../../thread-bindings-shared-CuWgf2Tf.js";
import { n as resolveMatrixEnvAuthReadiness, t as matrixSetupAdapter } from "../../setup-core-Cyu-PYpa.js";
import { t as updateMatrixAccountConfig } from "../../config-update-CNbza-bD.js";
import { c as validateMatrixHomeserverUrl, s as resolveValidatedMatrixHomeserverUrl } from "../../config-lPcQQpX9.js";
import "../../client-BZTWwJtN.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "../../resolve-targets-DR7b6yAJ.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "../../deps-BQXVctKc.js";
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("../../setup-bootstrap-B2dh7aTG.js");
