...
import "./accounts-DJUvrdlX.js";
import "./runtime-api-Csv9pQU1.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-BZ--ns19.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Binc2CpT.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-A0BDUdPL.js");
