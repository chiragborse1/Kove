import { a as hasConfiguredSecretInput, l as normalizeSecretInputString, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-mzCLKGg0.js";
import { t as enablePluginInConfig } from "./enable-D6L1I5Sn.js";
import { a as resolveBundledWebSearchPluginId, i as listBundledWebSearchProviders, n as sortWebSearchProviders } from "./web-search-providers.shared-B9qgJ_fs.js";
import { t as resolvePluginWebSearchProviders } from "./web-search-providers.runtime-DnANRvQd.js";
import { n as sortFlowContributionsByLabel } from "./types-CvNCRtYy.js";
...
async function runSearchSetupFlow(config, runtime, prompter, opts) {
	...
	if (!needsCredential) {
		await prompter.note([
			...
			"Kova will enable the plugin and use it as your web_search provider.",
			`Docs: ${entry.docsUrl ?? "https://docs.kova.ai/tools/web"}`
		].join("\n"), "Web search");
	...
	if (opts?.secretInputMode === "ref") {
		...
		await prompter.note([
			"Secret references enabled — Kova will store a reference instead of the API key.",
