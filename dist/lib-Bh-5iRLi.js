...
import { t as require_src } from "./src-DfNHt1EC.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DFx6dYuh.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DkiRHWB6.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-Bu8IaFfy.js";
import { l as toRatio, n as decodeString } from "./Util-jl3sE4lw.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-l746qSvn.js";
import { t as APEv2Parser } from "./APEv2Parser-B9qb2CfW.js";
import { r as hasID3v1Header } from "./ID3v1Parser-D7WfMOdm.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-4Go5WETq.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-BxfHtvml.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DWKuv8ln.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-Dd4S4etV.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-CZSmZpaq.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-I5QvOyUc.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-dDhP9sDV.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-A2p_d97C.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-B45GGqJU.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-B4GMx-zJ.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Do0O2Fir.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DynptKWX.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CYYYdq5a.js")).WaveParser;
	}
};
//#endregion
