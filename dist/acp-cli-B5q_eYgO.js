...
import { n as buildGatewayConnectionDetails } from "./call-Cmc_PDdk.js";
import { a as omitEnvKeysCaseInsensitive, r as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-Ccnv1zLb.js";
import { r as isKnownCoreToolId } from "./tool-catalog-Dgy8boYb.js";
import { r as listThinkingLevels } from "./thinking-BCjEONq4.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-CTaeI9lX.js";
import { r as isMutatingToolCall } from "./tool-mutation-HQ_jnJgd.js";
...
import { t as readSecretFromFile } from "./secret-file-C7GNHd4T.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-BGkd18Q0.js");
...
function printHelp() {
	console.log(`Usage: kova acp [options]
...
function registerAcpCli(program) {
	...
	acp.command("client").description("Run an interactive ACP client against the local ACP bridge").option("--cwd <dir>", "Working directory for the ACP session").option("--server <command>", "ACP server command (default: kova)").option("--server-args <args...>", "Extra arguments for the ACP server").option("--server-verbose", "Enable verbose logging on the ACP server", false).option("-v, --verbose", "Verbose client logging", false).action(async (opts, command) => {
