...
import { n as loadValidatedConfigForPluginRegistration, r as registerSubCliByName, t as getSubCliEntries } from "./register.subclis-4X5EEzmY.js";
import { n as registerCoreCliByName, t as getCoreCliCommandNames } from "./command-registry-DOP0stif.js";
import { t as getProgramContext } from "./program-context-BjqQCwhk.js";
...
async function completionCacheExists(shell, binName = "kova") {
...
async function isCompletionInstalled(shell, binName = "kova") {
...
*/
async function usesSlowDynamicCompletion(shell, binName = "kova") {
	const profilePath = getShellProfilePath(shell);
	if (!await pathExists(profilePath)) return false;
...
async function installCompletion(shell, yes, binName = "kova") {
	const home = process.env.HOME || os.homedir();
	let profilePath = "";
	let sourceLine = "";
