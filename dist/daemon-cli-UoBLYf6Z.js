...
import { d as readBestEffortConfig } from "./io-DcGUiGNW.js";
import "./config-Dl06sDj4.js";
import { t as formatCliCommand } from "./command-format-Wh1wnuz1.js";
import { n as buildGatewayInstallPlan, t as resolveGatewayInstallToken } from "./gateway-install-token-BC87VeYu.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CI1Fmm6N.js";
import { c as signalVerifiedGatewayPidSync, o as findVerifiedGatewayListenerPidsOnPortSync, r as resolveGatewayService, s as formatGatewayPidList } from "./service-C_gX92o7.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-BJqyInLQ.js";
import { h as installDaemonServiceAndEmit, l as renderGatewayServiceStartHints, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, s as parsePortFromArgs } from "./shared-BXizBDOo.js";
import { t as parsePort } from "./parse-port-Mfl8_hZl.js";
import { r as isRestartEnabled } from "./commands-CUuABr5j.js";
import { i as probeGateway } from "./probe-CFpxFdGB.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-vL2LEINf.js";
import { a as terminateStaleGatewayPids, i as renderRestartDiagnostics, n as DEFAULT_RESTART_HEALTH_ATTEMPTS, o as waitForGatewayHealthyListener, r as renderGatewayPortHealthDiagnostics, s as waitForGatewayHealthyRestart, t as runDaemonStatus } from "./status-BPfK1jML.js";
	...
	if (loaded) {
		if (!opts.force) if (await gatewayServiceNeedsAutoNodeExtraCaCertsRefresh({
			...
			if (!json) {
				...
				defaultRuntime.log(`Reinstall with: ${formatCliCommand("kova gateway install --force")}`);
			}
			return;
		}
	}
...
async function restartGatewayWithoutServiceManager(port) {
	...
	const pids = resolveVerifiedGatewayListenerPids(port);
	if (pids.length === 0) return null;
	if (pids.length > 1) throw new Error(`multiple gateway processes are listening on port ${port}: ${formatGatewayPidList(pids)}; use "kova gateway status --deep" before retrying restart`);
	...
	return await runServiceRestart({
		...
		postRestartCheck: async ({ warnings, fail, stdout }) => {
			if (restartedWithoutServiceManager) {
				...
				fail(`Gateway restart timed out after ${restartWaitSeconds}s waiting for health checks.`, [formatCliCommand("kova gateway status --deep"), formatCliCommand("kova doctor")]);
			}
