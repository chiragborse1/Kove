...
import { f as isRecord, v as resolveHomeDir } from "./utils-CQHEfYrT.js";
import { R as OpenClawSchema, f as readConfigFileSnapshot } from "./io-DcGUiGNW.js";
import "./config-Dl06sDj4.js";
import { n as formatConfigIssueLines } from "./issue-format-BI5rIoW9.js";
import { t as note } from "./note-MqXwK9Il.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-C15DgeIK.js");
