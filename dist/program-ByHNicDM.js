import { l as hasHelpOrVersion, n as getCommandPathWithRootOptions, s as getVerboseFlag } from "./argv-CrD4Uaj1.js";
...
import { c as routeLogsToStderr } from "./subsystem-D1w25rM-.js";
...
import { t as emitCliBanner } from "./banner-BX-nwFEl.js";
import { n as resolveCliChannelOptions } from "./channel-options-9-5-6XbJ.js";
import { n as resolveEffectiveCliCommandPath } from "./kova-aliases-D1ECR5dN.js";
import { i as registerProgramCommands } from "./command-registry-DOP0stif.js";
import { n as setProgramContext } from "./program-context-BjqQCwhk.js";
import { t as isCommandJsonOutputMode } from "./json-mode-BZshh-q5.js";
import "./ports-43FsGpy_.js";
import { n as resolvePluginInstallPreactionRequest, t as resolvePluginInstallInvalidConfigPolicy } from "./plugin-install-config-policy-Dex1jhIa.js";
import { t as configureProgramHelp } from "./help-BFTU0DXf.js";
...
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-wAWAoLBG.js");
	return configGuardModulePromise;
}
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-Cv6ybVOn.js");
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const commandPath = resolveEffectiveCliCommandPath(getCommandPathWithRootOptions(argv, 2), argv);
