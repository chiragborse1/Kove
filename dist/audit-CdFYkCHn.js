...
import { J as listRiskyConfiguredSafeBins, K as normalizeTrustedSafeBinDirs } from "./io-DcGUiGNW.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-mzCLKGg0.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-DxxNYgY4.js";
...
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-vpSSEUV4.js";
import { n as resolveSandboxConfigForAgent } from "./config-pDt0KpDN.js";
import { R as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-C-ADQo5x.js";
...
import { dt as resolveBrowserControlAuth, ft as resolveProfile, lt as redactCdpUrl, ut as resolveBrowserConfig } from "./browser-runtime-DNinsd0O.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DJnchMar.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-Lwpz1W4y.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-B-3cRxB7.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-Ni5st6tk.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-CJcSCwCM.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DEzb0ME1.js"),
		import("./probe-auth--FlvsTzD.js"),
		import("./probe-DKqVnTNJ.js")
