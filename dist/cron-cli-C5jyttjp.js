...
import { f as sanitizeAgentId } from "./session-key-vgS1x1jn.js";
import { t as danger } from "./globals-CxHdnmm2.js";
import { n as listChannelPlugins } from "./registry-4IMxEMRc.js";
import "./plugins-CsZ0NNl7.js";
import { n as formatDurationHuman } from "./format-duration-BwgwzyDX.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs } from "./stagger--72v8ONr.js";
...
function registerCronCli(program) {
	const cron = program.command("cron").description("Manage cron jobs (via Gateway)").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/cron", "docs.kova.ai/cli/cron")}\n${theme.muted("Upgrade tip:")} run \`kova doctor --fix\` to normalize legacy cron job storage.\n`);
