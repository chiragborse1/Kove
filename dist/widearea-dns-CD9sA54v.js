import { t as CONFIG_DIR, u as ensureDir } from "./utils-CQHEfYrT.js";
...
function renderZone(opts) {
	...
	const hostLabel = dnsLabel(opts.hostLabel ?? hostname, "kova");
	const instanceLabel = dnsLabel(opts.instanceLabel ?? `${hostname}-gateway`, "kova-gw");
