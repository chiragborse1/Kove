import { f as resolveIsNixMode } from "./paths-CG2veZVr.js";
...
import { d as resolveSecretInputRef } from "./types.secrets-mzCLKGg0.js";
import "./config-Dl06sDj4.js";
import { s as trimToUndefined, t as createGatewayCredentialPlan } from "./credential-planner-B0vdUPPY.js";
import { n as isGatewaySecretRefUnavailableError, t as GatewaySecretRefUnavailableError } from "./credentials-D-Qn12vP.js";
import { t as isWSL } from "./wsl-DCvWupN8.js";
import { i as startGatewayService, t as describeGatewayServiceRestart } from "./service-C_gX92o7.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-BJqyInLQ.js";
import { i as filterContainerGenericHints, m as createDaemonActionContext, p as buildDaemonServiceSnapshot } from "./shared-BXizBDOo.js";
import { a as checkTokenDrift, n as renderSystemdUnavailableHints } from "./systemd-hints-C9EXVN-A.js";
...
async function runServiceStart(params) {
	...
	}) === null) return;
	{
		...
		if (configError) {
			fail(`${params.serviceNoun} aborted: config is invalid.\n${configError}\nFix the config and retry, or run "kova doctor" to repair.`);
			return;
		}
	}
	try {
