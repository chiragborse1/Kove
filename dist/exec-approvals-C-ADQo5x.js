import { b as expandHomePrefix } from "./paths-CG2veZVr.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-vgS1x1jn.js";
import { At as DEFAULT_SAFE_BINS, St as isShellWrapperExecutable, W as isTrustedSafeBinPath, Z as analyzeShellCommand, _t as resolveExecWrapperTrustPlan, at as matchAllowlist, bt as extractShellWrapperInlineCommand, dt as resolveExecutionTargetCandidatePath, ft as resolveExecutionTargetResolution, ht as resolvePolicyTargetResolution, it as splitCommandChainWithOperators, jt as SAFE_BIN_PROFILES, kt as normalizeExecutableToken, mt as resolvePolicyTargetCandidatePath, q as validateSafeBinArgv, tt as isWindowsPlatform, ut as resolveCommandResolutionFromArgv } from "./io-DcGUiGNW.js";
...
function resolveAgentSecurityField(params) {
	...
	if (agentValue != null) {
		if (isExecSecurity(agentValue)) return {
			value: agentValue,
	...
	if (wildcardValue != null) {
		if (isExecSecurity(wildcardValue)) return {
			value: wildcardValue,
...
//#endregion
export { evaluateExecAllowlist as A, resolveExecApprovalRequestAllowedDecisions as C, resolveExecApprovalsSocketPath as D, resolveExecApprovalsPath as E, resolveSafeBins as F, describeInterpreterInlineEval as I, detectInterpreterInlineEvalArgv as L, isSafeBinUsage as M, normalizeSafeBins as N, saveExecApprovals as O, resolveAllowAlwaysPatterns as P, isInterpreterLikeAllowlistPattern as R, resolveExecApprovalAllowedDecisions as S, resolveExecApprovalsFromFile as T, normalizeExecTarget as _, addDurableCommandApproval as a, requestExecApprovalViaSocket as b, isExecApprovalDecisionAllowed as c, mergeExecApprovalsSocketDefaults as d, minSecurity as f, normalizeExecSecurity as g, normalizeExecHost as h, addAllowlistEntry as i, evaluateShellAllowlist as j, requestJsonlSocket as k, loadExecApprovals as l, normalizeExecAsk as m, DEFAULT_EXEC_APPROVAL_DECISIONS as n, ensureExecApprovals as o, normalizeExecApprovals as p, DEFAULT_EXEC_APPROVAL_TIMEOUT_MS as r, hasDurableExecApproval as s, DEFAULT_EXEC_APPROVAL_ASK_FALLBACK as t, maxAsk as u, readExecApprovalsSnapshot as v, resolveExecApprovals as w, requiresExecApproval as x, recordAllowlistUse as y };
