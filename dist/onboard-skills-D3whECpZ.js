...
import { p as resolveNodeManagerOptions } from "./onboard-helpers-BPgzEhsc.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C0pH3Yqh.js";
import { t as installSkill } from "./skills-install-5YOkWhR7.js";
...
async function setupSkills(cfg, workspaceDir, runtime, prompter) {
	...
	if (installable.length > 0) {
		...
		for (const name of selected) {
			...
			runtime.log(`Tip: run \`${formatCliCommand("kova doctor")}\` to review skills + requirements.`);
			runtime.log("Docs: https://docs.kova.ai/skills");
		}
	}
