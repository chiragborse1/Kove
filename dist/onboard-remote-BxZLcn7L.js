...
import { i as discoverGatewayBeacons, n as buildGatewayDiscoveryTarget, t as buildGatewayDiscoveryLabel } from "./gateway-discovery-targets-BZ8sjgmW.js";
...
async function promptRemoteGatewayConfig(cfg, prompter, options) {
	...
	if (!hasBonjourTool) await prompter.note(["Bonjour discovery requires dns-sd (macOS) or avahi-browse (Linux).", "Docs: https://docs.kova.ai/gateway/discovery"].join("\n"), "Discovery");
	if (wantsDiscover) {
