...
import { c as GroupPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-1c4_V7ob.js";
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-Cc0c0E9K.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Ck6TZ9om.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate } from "./common-CGHRdLb5.js";
...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CytOxUFv.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-CoTfioXV.js";
...
import { f as createAllowlistProviderOpenWarningCollector, y as projectAccountConfigWarningCollector } from "./group-policy-warnings-dszdQwvS.js";
...
import { r as buildTrafficStatusSummary } from "./extension-shared-hQCaveVt.js";
import "./channel-status-CLZJKnFo.js";
import { t as zod_exports } from "./zod-Dxa-uX1l.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-MV00QQJ5.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-CAwnU3f8.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-DPhKh629.js";
import "./runtime-api-BXg1F8gg.js";
import { n as normalizeMatrixAllowList, r as normalizeMatrixUserId, t as resolveMatrixRoomConfig } from "./rooms-CqCCaCe5.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-B2RtWZsE.js";
...
import { t as matrixSetupAdapter } from "./setup-core-Cyu-PYpa.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-BVZv4dC6.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CsyR-k45.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-B3dPlcJq2.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
