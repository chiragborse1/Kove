...
function buildScanFailureBlockReason(params) {
	return `${params.targetLabel} blocked: code safety scan failed (${params.error}). Run "kova security audit --deep" for details.`;
}
...
async function scanBundleInstallSourceRuntime(params) {
	const builtinScan = await scanDirectoryTarget({
		...
		suspiciousMessage: `Bundle "{target}" has {count} suspicious code pattern(s). Run "kova security audit --deep" for details.`,
...
async function scanPackageInstallSourceRuntime(params) {
	...
	const builtinScan = await scanDirectoryTarget({
		...
		suspiciousMessage: `Plugin "{target}" has {count} suspicious code pattern(s). Run "kova security audit --deep" for details.`,
		targetName: params.pluginId,
...
async function scanFileInstallSourceRuntime(params) {
	const builtinScan = await scanFileTarget({
		...
		suspiciousMessage: `Plugin file "{target}" has {count} suspicious code pattern(s). Run "kova security audit --deep" for details.`,
		targetName: params.pluginId,
...
async function scanSkillInstallSourceRuntime(params) {
	const builtinScan = await scanDirectoryTarget({
		logger: params.logger,
		path: params.sourceDir,
		suspiciousMessage: "Skill \"{target}\" has {count} suspicious code pattern(s). Run \"kova security audit --deep\" for details.",
