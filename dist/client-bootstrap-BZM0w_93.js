...
import { t as getActiveMatrixClient } from "./active-client-D00_odsa.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-CGV9Y-TO.js"), import("./shared-BqDASXve.js")]).then(([clientModule, sharedModule]) => ({
