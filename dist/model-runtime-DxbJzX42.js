...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-Cdhvx72k.js";
import "./host-env-security-CSk3FuWM.js";
import { t as killProcessTree } from "./kill-tree-DyFhPOYG.js";
import { r as generateSecureInt } from "./secure-random-DaCqgcX8.js";
import { S as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-C-ADQo5x.js";
import { n as requestHeartbeatNow } from "./heartbeat-wake-ZPnHC9FI.js";
import { n as findPathKey, r as mergePathPrepend } from "./path-prepend-Buutjh8r.js";
import { r as enqueueSystemEvent } from "./system-events-B_Ek90ik.js";
import { D as clampWithDefault, E as chunkString, j as readEnvInt, w as buildDockerExecArgs } from "./sandbox-CbS9LA4E.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-2QbaPMEB.js");
