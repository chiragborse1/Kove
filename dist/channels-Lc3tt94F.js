...
import { r as loadAuthProfileStore } from "./store-CSVK41Xr.js";
import "./auth-profiles-CBD_gvpA.js";
import { _ as normalizeAccountId } from "./session-key-vgS1x1jn.js";
import { t as danger } from "./globals-CxHdnmm2.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-DvZddQZR.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BLYLA3dm.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-53L_PGcM.js";
...
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-B3XsQSzz.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-CaAReSmj.js";
import { n as formatTimeAgo } from "./format-relative-Bo03qcyi.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-D8K8E2BC.js";
import { t as createClackPrompter } from "./clack-prompter-CRl8DnoH.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BORMIiNK.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-Tx6dkWac.js";
import { t as parseLogLine } from "./parse-log-line-EjlxsiMw.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-6xyCB-Eb.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-B60YLwrN.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-BXc6bg7g.js"), import("./onboard-channels-C9PrWFli.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-C0BJbQlr.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-C0BJbQlr.js");
			const prompter = createClackPrompter();
