...
import { D as truncateUtf16Safe, b as resolveUserPath } from "./utils-CQHEfYrT.js";
...
import { r as listMemoryEmbeddingProviders, t as getMemoryEmbeddingProvider } from "./memory-embedding-providers-DEBAX0cK.js";
import { n as getProviderEnvVars } from "./provider-env-vars-Ccnv1zLb.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-BY767xAw.js";
import { t as resolveMemorySearchConfig } from "./memory-search-C9FPakr-.js";
import { t as extractKeywords } from "./query-expansion-fbtByt8w.js";
import { l as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "./ollama-C47cDVSn.js";
import { _ as estimateUtf8Bytes, a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, g as estimateStructuredEmbeddingInputBytes, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-CYaB3n3v.js";
import { r as readMemoryFile } from "./backend-config-CjuLKwWr.js";
import { a as runGeminiEmbeddingBatches, c as DEFAULT_VOYAGE_EMBEDDING_MODEL, d as createOpenAiEmbeddingProvider, f as DEFAULT_MISTRAL_EMBEDDING_MODEL, g as createGeminiEmbeddingProvider, h as buildGeminiEmbeddingRequest, i as runOpenAiEmbeddingBatches, l as createVoyageEmbeddingProvider, m as DEFAULT_GEMINI_EMBEDDING_MODEL, n as runVoyageEmbeddingBatches, o as DEFAULT_LOCAL_MODEL, p as createMistralEmbeddingProvider, r as OPENAI_BATCH_ENDPOINT, s as createLocalEmbeddingProvider, t as enforceEmbeddingMaxInputTokens, u as DEFAULT_OPENAI_EMBEDDING_MODEL } from "./memory-core-host-engine-embeddings-CXzgXETx.js";
import "./memory-core-host-engine-foundation-CVq8cmMX.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, u as sessionPathForFile } from "./memory-core-host-engine-qmd-DLn3qqnI.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./memory-core-host-engine-storage-B4yfbpMd.js";
import "./provider-env-vars-Drkur-Gq.js";
