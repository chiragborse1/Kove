...
import { f as normalizeVerboseLevel, p as resolveResponseUsageMode } from "./thinking.shared-uAOYS_b_.js";
import { s as isCliProvider } from "./model-selection-CdS674HX.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-vgS1x1jn.js";
import { r as logVerbose } from "./globals-CxHdnmm2.js";
import { _ as resolveRunModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-PYTdAamx.js";
import { c as loadConfig } from "./io-DcGUiGNW.js";
import "./config-Dl06sDj4.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-CAdct431.js";
import { C as resolveGroupSessionKey, d as updateSessionStore, f as updateSessionStoreEntry, i as loadSessionStore } from "./store-nI7efowo.js";
import "./sessions-Sa--dLyw.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-B2rgdouq.js";
import { a as resolveFreshSessionTotalTokens } from "./types-CV1Cji38.js";
import { a as isAudioFileName } from "./mime-DZjPKZZF.js";
import { u as resolveMemoryFlushPlan } from "./memory-state-Sm982BGU.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-B5NhZrWK.js";
import { a as stripHeartbeatToken } from "./heartbeat-BX_FfPLq.js";
...
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-CQ_1KEhN.js";
import { a as scheduleFollowupDrain, n as enqueueFollowupRun, o as refreshQueuedFollowupSession } from "./queue-B5ASO9b3.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-B3n0Qxtk.js";
...
import { n as resolveSandboxConfigForAgent } from "./config-pDt0KpDN.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CFVBO2YZ.js";
import "./thinking-BCjEONq4.js";
import { c as resolveModelAuthMode } from "./model-auth-CyDzECEz.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-BtgADydu.js";
import { h as resolvePathFromInput, o as parseReplyDirectives, p as resolveEffectiveToolFsWorkspaceOnly } from "./deliver-DumQsWB_.js";
import { r as enqueueSystemEvent } from "./system-events-B_Ek90ik.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-CbS9LA4E.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Cu4vfSif.js";
import { i as isRenderablePayload, n as applyReplyThreading, o as createReplyToModeFilterForChannel, s as resolveReplyToMode, t as applyReplyTagsToPayload } from "./reply-payloads-DguHbxkA.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-By8-xQ1Y.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-UoDWK0R_.js";
import { a as registerAgentRunContext, n as emitAgentEvent } from "./agent-events-PDNSe-bQ.js";
import { _ as readSessionMessages } from "./session-utils-BGL8dvHO.js";
import { t as lookupContextTokens } from "./context-CUhjRubn.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-BWXY40wm.js";
import { i as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-B7tRqYWz.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CiQy6f5j.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-BC2EzQqM.js";
import { t as createTypingSignaler } from "./typing-mode-BeeYAICr.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-Cv-bBPzO.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-B1H0MEN5.js";
import { a as resolveModelFallbackOptions, i as isBunFetchSocketError, o as resolveRunAuthProfile, r as formatBunFetchSocketError, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CA6Gzexf.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-DLfKeYfR.js";
	...
	while (true) try {
		...
		if (err instanceof LiveSessionModelSwitchError) {
			...
			if (liveModelSwitchRetries > 2) {
				...
				return {
					kind: "final",
					payload: { text: shouldSurfaceToControlUi ? "⚠️ Agent failed before reply: model switch could not be completed. The requested model may be temporarily unavailable.\nLogs: kova logs --follow" : "⚠️ Agent failed before reply: model switch could not be completed. The requested model may be temporarily unavailable. Please try again shortly." }
				};
			}
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-CKTmFF9f.js");
