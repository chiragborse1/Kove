import { c as hasFlag, u as hasRootVersionAlias } from "./argv-CrD4Uaj1.js";
import { _ as ALLOWED_LOG_LEVELS, b as tryParseLogLevel } from "./logger-Cnt8m3Fg.js";
...
import { i as hasEmittedCliBanner, r as formatCliBannerLine } from "./banner-BX-nwFEl.js";
import { n as getCoreCliCommandsWithSubcommands } from "./core-command-descriptors-DInmo6zP.js";
import { t as getSubCliCommandsWithSubcommands } from "./subcli-descriptors-CJ3aIg0Z.js";
...
const EXAMPLES = [
	...
	["kova message send --target +15555550123 --message \"Hi\" --json", "Send via your web session and print JSON result."],
	...
	["kova agent --to +15555550123 --message \"Run summary\" --deliver", "Talk directly to the agent using the Gateway; optionally send the WhatsApp reply."],
	["kova message send --channel telegram --target @mychat --message \"Hi\"", "Send via your Telegram bot."]
];
