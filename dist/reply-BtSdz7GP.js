...
import { n as formatXHighModelHint, u as normalizeThinkLevel } from "./thinking.shared-uAOYS_b_.js";
import { v as resolveModelRefFromString } from "./model-selection-CdS674HX.js";
import { T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-vgS1x1jn.js";
import { r as logVerbose } from "./globals-CxHdnmm2.js";
import { r as normalizeStringEntries, t as normalizeAtHashSlug } from "./string-normalization-8NDpjxKG.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, n as listAgentEntries, p as resolveAgentWorkspaceDir, v as resolveSessionAgentId } from "./agent-scope-PYTdAamx.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-DBgoItUM.js";
import { c as loadConfig } from "./io-DcGUiGNW.js";
import { n as getActivePluginChannelRegistryVersion } from "./runtime-D0EER0KC.js";
import { a as CHAT_CHANNEL_ORDER } from "./chat-meta-_mVp3ucX.js";
import "./registry-L-LA-YJT.js";
import { t as applyMergePatch } from "./merge-patch-Bv-ypbzf.js";
import "./config-Dl06sDj4.js";
import { t as formatCliCommand } from "./command-format-Wh1wnuz1.js";
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-CAdct431.js";
import { C as resolveGroupSessionKey, b as deriveSessionMetaPatch, d as updateSessionStore, i as loadSessionStore } from "./store-nI7efowo.js";
import { t as normalizeChatType } from "./chat-type-BjcvDs4y.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-4IMxEMRc.js";
import "./plugins-CsZ0NNl7.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-Boe1XF3k.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-B2rgdouq.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CV1Cji38.js";
import { a as resolveSessionResetType, i as resolveSessionResetPolicy, n as evaluateSessionFreshness, o as resolveThreadFlag, r as resolveChannelResetConfig, t as resolveAndPersistSessionFile } from "./session-file-BCUUiCxa.js";
import { n as resolveSessionKey } from "./session-key-crL5znw2.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-YIhsEWeQ.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CKoMjNyz.js";
import { t as normalizeConversationText } from "./conversation-id-Cp_e3CNB.js";
import { r as getSessionBindingService } from "./session-binding-service-B_GIaT8n.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-DRuWmhD8.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-B5NhZrWK.js";
import { i as generateSecureToken } from "./secure-random-DaCqgcX8.js";
import { C as resolveFastModeState, D as getQueueSize, t as resolveQueueSettings, w as clearCommandLane } from "./queue-B5ASO9b3.js";
import { d as isReasoningTagProvider, n as resolveAgentTimeoutMs, o as disposeSessionMcpRuntime, t as collectTextContentBlocks } from "./content-blocks-DHUAuqmI.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-BaEXj_Uc.js";
import { t as applyOwnerOnlyToolPolicy } from "./tool-policy-Doc9ZwAB.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CFVBO2YZ.js";
import { i as supportsXHighThinking } from "./thinking-BCjEONq4.js";
import { r as enqueueSystemEvent } from "./system-events-B_Ek90ik.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-DPtOmaDh.js";
import { t as buildOutboundSessionContext } from "./session-context-B1f4f5Qh.js";
import { t as normalizeGroupActivation } from "./group-activation-BMy1Runq.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Dbt5K5Nl.js";
import { t as hasControlCommand } from "./command-detection-bnokfh10.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-B0TqX4XH.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-DDKFz-7a.js";
import { t as finalizeInboundContext } from "./inbound-context-CGnjX-ne.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-Dvl2s3iI.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-D-3dWvyu.js";
import { n as parseInlineDirectives, t as isDirectiveOnly } from "./directive-handling.parse-CqpI2qQ2.js";
import { t as resolveCommandAuthorization } from "./command-auth-BApfyQnY.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-BDLAMNv-.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CiQy6f5j.js";
import { t as buildCommandContext } from "./commands-context-CUNTt1iQ.js";
import { t as extractExplicitGroupId } from "./group-id-CcsUNOct.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-C0MfuXEw.js";
import { n as resolveContextTokens, t as createModelSelectionState } from "./model-selection-CC4Dy-d9.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-Dgin39ik.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-B1ws4nOb.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-BC2EzQqM.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-BMJI54s9.js";
import { n as resolveTypingMode } from "./typing-mode-BeeYAICr.js";
import { i as resolveConversationBindingContextFromMessage, o as resolveEffectiveResetTargetSessionKey } from "./conversation-binding-input-BN-X5N_W.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-y5iiKlCa.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-C1oRcRZs.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CCh2D9F7.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-DZkb4MhB.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-OS1J1Un3.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-Daxa80J3.js");
...
function buildGroupIntro(params) {
	...
	return [
		...
		activation === "always" ? `If no response is needed, reply with exactly "${params.silentToken}" (and nothing else) so Kova stays silent. Do not add any other words, punctuation, tags, markdown/code blocks, or explanations.` : void 0,
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-D9ZbEebI.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-hH2MZiEb.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-hH2MZiEb.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		skillFilter
	}) : [];
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-B8qbMWHv.js");
	...
	if (!isAbortRequestText(command.rawBodyNormalized) && sessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-J8MGzeMB.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-DR9u9I9u.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-DR9u9I9u.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-CIQ86Kjc.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-BstkBePj.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-CiRFPEyP.js");
	return agentRunnerRuntimePromise;
}
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-Ci4Kqo7l.js");
	return routeReplyRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-0SrZGn3n.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-CIQ86Kjc.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CdY4aE-O.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-DbrUAhzf.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-DS-6Za95.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-Drr67n8K.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-B4wd8vib.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-DFflvFOO.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-BVUTLJGu.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-cTG6qW77.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-DoJBsgxW.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-BsshzAP8.js");
