...
import { r as theme, t as colorize } from "./theme-DwswwArY.js";
import { i as resolveAgentConfig } from "./agent-scope-PYTdAamx.js";
import { t as sameFileIdentity } from "./file-identity-D3B_iLcc.js";
import { a as logWarn } from "./logger-DiTvWLNg.js";
import { Ct as unwrapKnownShellMultiplexerInvocation, Et as resolveInlineCommandMatch, Ot as unwrapKnownDispatchWrapperInvocation, X as analyzeArgvCommand, c as loadConfig, ct as resolveApprovalAuditCandidatePath, gt as resolveExecutableFromPathEnv, kt as normalizeExecutableToken, nt as resolvePlannedSegmentArgv, ut as resolveCommandResolutionFromArgv, vt as POSIX_SHELL_WRAPPERS, wt as POSIX_INLINE_COMMAND_FLAGS } from "./io-DcGUiGNW.js";
import { a as sanitizeHostExecEnv, s as sanitizeSystemRunEnvOverrides, t as inspectHostExecEnvOverrides } from "./host-env-security-CSk3FuWM.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-Ce1e_DDq.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-CnvmWmA7.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-C0Y8zcXe.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CI1Fmm6N.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES } from "./message-channel-CAdct431.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-CNuUiVKA.js";
import { u as GatewayClient } from "./method-scopes-DZkQBBD6.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BXizBDOo.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-C9EXVN-A.js";
import { t as parsePort } from "./parse-port-Mfl8_hZl.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-vL2LEINf.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CGZ5bxHl.js";
import { A as evaluateExecAllowlist, I as describeInterpreterInlineEval, L as detectInterpreterInlineEvalArgv, O as saveExecApprovals, P as resolveAllowAlwaysPatterns, a as addDurableCommandApproval, d as mergeExecApprovalsSocketDefaults, i as addAllowlistEntry, j as evaluateShellAllowlist, k as requestJsonlSocket, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as readExecApprovalsSnapshot, w as resolveExecApprovals, x as requiresExecApproval, y as recordAllowlistUse } from "./exec-approvals-C-ADQo5x.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-SzvpOAQ1.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-m5hJdfBD.js";
import { J as runBrowserProxyCommand, ut as resolveBrowserConfig } from "./browser-runtime-DNinsd0O.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-A8Nn6Yhp.js";
...
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-Dz0W5AW-.js";
...
function renderNodeServiceStartHints() {
	return buildPlatformServiceStartHints({
		installCommand: formatCliCommand("kova node install"),
		startCommand: formatCliCommand("kova node start"),
...
async function runNodeDaemonInstall(opts) {
	...
	if (loaded && !opts.force) {
		...
		if (!json) {
			...
			defaultRuntime.log(`Reinstall with: ${formatCliCommand("kova node install --force")}`);
		}
		return;
	}
...
function registerNodeCli(program) {
	const node = program.command("node").description("Run and manage the headless node host service").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["kova node run --host 127.0.0.1 --port 18789", "Run the node host in the foreground."],
		["kova node status", "Check node host service status."],
		["kova node install", "Install the node host service."],
		["kova node restart", "Restart the installed node host service."]
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/node", "docs.kova.ai/cli/node")}\n`);
