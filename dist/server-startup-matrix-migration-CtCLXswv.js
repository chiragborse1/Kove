...
import { t as resolveStableNodePath } from "./stable-node-path-DQj5hK1S.js";
import { i as parseAbsoluteTimeMs } from "./stagger--72v8ONr.js";
import { o as trimLogTail } from "./restart-sentinel-DJXvg4HW.js";
import { i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, t as hasActionableMatrixMigration } from "./matrix-migration-snapshot-UcdtJCC6.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-jUFD58KC.js";
import { a as isBetaTag, n as DEV_BRANCH, o as isStableTag, r as channelToNpmTag } from "./update-channels-CSuYrAWA.js";
import { n as compareSemverStrings, s as detectPackageManager$1 } from "./update-check-DOpmXLpi.js";
import { c as globalInstallFallbackArgs, d as resolveGlobalPackageRoot, f as normalizePackageTagInput, i as createGlobalInstallEnv, l as resolveExpectedInstalledVersionFromSpec, m as readPackageVersion, n as cleanupGlobalRenameDirs, o as detectGlobalInstallManagerForRoot, p as readPackageName, r as collectInstalledGlobalPackageErrors, s as globalInstallArgs, u as resolveGlobalInstallSpec } from "./update-global-MbGSNuuu.js";
...
async function runGatewayUpdate(opts = {}) {
	...
	if (gitRoot && pkgRoot && path.resolve(gitRoot) === path.resolve(pkgRoot)) {
		...
		if (channel === "dev") {
			...
			const preflightRoot = await fs.mkdtemp(path.join(os.tmpdir(), "kova-update-preflight-"));
...
//#endregion
export { computePreviousRunAtMs as a, computeNextRunAtMs as i, runGatewayUpdate as n, coerceFiniteScheduleNumber as r, runStartupMatrixMigration as t };
