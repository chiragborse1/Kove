...
import { T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-vgS1x1jn.js";
import { i as resolveAgentConfig } from "./agent-scope-PYTdAamx.js";
import { c as loadConfig } from "./io-DcGUiGNW.js";
import { a as normalizeAnyChannelId } from "./registry-L-LA-YJT.js";
import "./config-Dl06sDj4.js";
import { t as formatCliCommand } from "./command-format-Wh1wnuz1.js";
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CAdct431.js";
import { i as loadSessionStore } from "./store-nI7efowo.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey } from "./main-session-Boe1XF3k.js";
import "./sessions-Sa--dLyw.js";
import { l as resolveStorePath } from "./paths-B2rgdouq.js";
import { n as resolveSandboxConfigForAgent, o as resolveSandboxToolPolicyForAgent } from "./config-pDt0KpDN.js";
import { i as removeSandboxContainer, n as listSandboxContainers, r as removeSandboxBrowserContainer, t as listSandboxBrowsers } from "./sandbox-CbS9LA4E.js";
...
const SANDBOX_EXAMPLES = {
	main: [
		["kova sandbox list", "List all sandbox containers."],
		["kova sandbox list --browser", "List only browser containers."],
		["kova sandbox recreate --all", "Recreate all containers."],
		["kova sandbox recreate --session main", "Recreate a specific session."],
		["kova sandbox recreate --agent mybot", "Recreate agent containers."],
		["kova sandbox explain", "Explain effective sandbox config."]
	],
	list: [
		["kova sandbox list", "List all sandbox containers."],
		["kova sandbox list --browser", "List only browser containers."],
	...
	recreate: [
		["kova sandbox recreate --all", "Recreate all containers."],
		["kova sandbox recreate --session main", "Recreate a specific session."],
		["kova sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
		["kova sandbox recreate --browser --all", "Recreate only browser containers."],
		["kova sandbox recreate --all --force", "Skip confirmation."]
	],
	explain: [
		["kova sandbox explain", "Show effective sandbox config."],
		["kova sandbox explain --session agent:main:main", "Explain a specific session."],
		["kova sandbox explain --agent work", "Explain an agent sandbox."],
		["kova sandbox explain --json", "JSON output."]
	]
};
