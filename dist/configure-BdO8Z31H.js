import { d as resolveGatewayPort, t as CONFIG_PATH } from "./paths-CG2veZVr.js";
import { n as defaultRuntime } from "./runtime-kS8e4c6-.js";
import { C as shortenHomePath, b as resolveUserPath, c as displayPath } from "./utils-CQHEfYrT.js";
...
import { c as loadConfig, f as readConfigFileSnapshot } from "./io-DcGUiGNW.js";
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-mzCLKGg0.js";
...
import { a as findTailscaleBinary } from "./tailscale-DQf6kWwq.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-4IMxEMRc.js";
import "./plugins-CsZ0NNl7.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, h as validateGatewayPasswordInput, m as summarizeExistingConfig, n as applyWizardMetadata, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BPgzEhsc.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-BJqyInLQ.js";
import { n as withProgress } from "./progress-CmYGpvY2.js";
...
import { n as resolveProviderPluginChoice } from "./provider-wizard-ChUbql-_.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-jUFD58KC.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CSf120mY.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-HqTCVLEp.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-hjCwYPxb.js";
import { n as applyAuthChoice } from "./auth-choice-DSo1P4MK.js";
import { i as noteChannelStatus, r as setupChannels } from "./onboard-channels-B60YLwrN.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BUPFW5dE.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BXYlQVsq.js";
import { i as promptCustomApiConfig } from "./onboard-custom-DEKmX4OO.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-oPPL2e8v.js";
import { t as formatHealthCheckFailure } from "./health-format-Bmh-oSqv.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BxZLcn7L.js";
import { t as setupSkills } from "./onboard-skills-D3whECpZ.js";
...
async function removeChannelConfigWizard(cfg, runtime) {
	...
	while (true) {
		...
		if (configured.length === 0) {
			note$1(["No channel config found in kova.json.", `Tip: \`${formatCliCommand("kova channels status")}\` shows what is configured and enabled.`].join("\n"), "Remove channel");
			return next;
		}
...
async function promptGatewayConfig(cfg, runtime) {
	...
	if (authMode === "token") if (guardCancel(await select$1({
		...
		note$1(`Validated ${envVarName}. Kova will store a token SecretRef.`, "Gateway token");
	} else {
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BseSI0e8.js");
	const { describeCodexNativeWebSearch, isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-DuJ4AQW-.js");
	...
	try {
		...
		const configureWorkspace = async () => {
			...
			if (!snapshot.exists) {
				...
				}))).some(Boolean)) note$1([`Existing workspace detected at ${displayPath(workspaceDir)}`, "Existing files are preserved. Missing templates may be created, never overwritten."].join("\n"), "Existing workspace");
			}
			nextConfig = {
				...nextConfig,
				agents: {
