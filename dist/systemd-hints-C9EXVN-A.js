import { _ as isNodeRuntime, g as isBunRuntime } from "./argv-CrD4Uaj1.js";
import { t as formatCliCommand } from "./command-format-Wh1wnuz1.js";
import { l as getMinimalServicePathPartsFromEnv, n as isVersionManagedNodePath, o as resolveSystemNodePath, t as isSystemNodePath } from "./runtime-paths-C0Y8zcXe.js";
import { a as toPosixPath } from "./runtime-parse-C7yIQB04.js";
import { c as resolveGatewayLogPaths, l as resolveLaunchAgentPlistPath } from "./launchd-Cx-dD96U.js";
import { p as classifySystemdUnavailableDetail, s as resolveSystemdUserUnitPath } from "./systemd-BJqyInLQ.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-Duv1f_Dk.js";
...
function auditGatewayToken(command, issues, expectedGatewayToken) {
	...
	issues.push({
		...
		message: "Gateway service OPENCLAW_GATEWAY_TOKEN does not match gateway.auth.token in kova.json",
