import { p as shouldMigrateStateFromPath } from "./argv-CrD4Uaj1.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-CbCd7662.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-CWlUFJ8E.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-tySoCUZw.js"),
		import("./utils-H4c3X34y.js"),
		import("./command-format-CHLqPCzu.js")
	]);
	const rich = isRich();
	...
	params.runtime.error(`${muted("Run:")} ${commandText(formatCliCommand("kova doctor --fix"))}`);
