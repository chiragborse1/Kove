...
import { d as updateSessionStore, g as enforceSessionDiskBudget, h as resolveMaintenanceConfig, i as loadSessionStore, m as pruneStaleEntries, p as capEntryCount } from "./store-nI7efowo.js";
import "./sessions-Sa--dLyw.js";
import { i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-B2rgdouq.js";
import { Et as cancelTaskById, Ft as updateTaskNotifyPolicyById, kt as getTaskById } from "./pi-embedded-BJKTXjFk.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-nSr98EmJ.js";
import { n as runCommandWithRuntime } from "./cli-utils-Ck3m3E7C.js";
import { t as formatHelpExamples } from "./help-format-B6p6tNX6.js";
import { n as parsePositiveIntOrUndefined } from "./helpers-BYrvRb09.js";
import { r as healthCommand } from "./health-Ctgc6rv9.js";
import { a as reconcileInspectableTasks, c as runTaskRegistryMaintenance, f as listTaskAuditFindings, i as previewTaskRegistryMaintenance, n as getInspectableTaskRegistrySummary, o as reconcileTaskLookupToken, p as summarizeTaskAuditFindings, t as getInspectableTaskAuditSummary } from "./task-registry.maintenance-Fz_7zc3H.js";
import { t as statusCommand } from "./status-BsV4lGtU.js";
import { a as formatSessionModelCell, c as toSessionDisplayRows, i as formatSessionKeyCell, l as resolveSessionStoreTargetsOrExit, n as formatSessionAgeCell, o as resolveSessionDisplayDefaults, r as formatSessionFlagsCell, s as resolveSessionDisplayModel, t as sessionsCommand } from "./sessions-BIGLaK7A.js";
...
function registerStatusHealthSessionsCommands(program) {
	...
	])}`).addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/status", "docs.kova.ai/cli/status")}\n`).action(async (opts) => {
	...
	sessionsCmd.command("cleanup").description("Run session-store maintenance now").option("--store <path>", "Path to session store (default: resolved from config)").option("--agent <id>", "Agent id to maintain (default: configured default agent)").option("--all-agents", "Run maintenance across all configured agents", false).option("--dry-run", "Preview maintenance actions without writing", false).option("--enforce", "Apply maintenance even when configured mode is warn", false).option("--fix-missing", "Remove store entries whose transcript files are missing (bypasses age/count retention)", false).option("--active-key <key>", "Protect this session key from budget-eviction").option("--json", "Output JSON", false).addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		...
		["kova sessions cleanup --dry-run --fix-missing", "Also preview pruning entries with missing transcript files."],
