...
import { bt as replaceSubagentRunAfterSteer } from "./pi-embedded-BJKTXjFk.js";
		...
		for (const [runId, runRecord] of activeRuns.entries()) {
			...
			try {
				...
				if (await resumeOrphanedSession({
					...
					configChangeHint: configChangeDetected ? "\n\n[config changes from your previous run were already applied — do not re-modify kova.json or restart the gateway]" : void 0,
					originalRunId: runId,
