...
import { b as resolveUserPath, d as escapeRegExp, t as CONFIG_DIR } from "./utils-CQHEfYrT.js";
...
import { o as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-ClgCj0m6.js";
...
import "./logging-core-B-iKbFMS.js";
import { a as ensureGatewayStartupAuth } from "./nodes.helpers-2KWUV1Lb.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BzqKOx6b.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BzqKOx6b.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-BzqKOx6b.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
