...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-91_G-DHK.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CS1HEQMc.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createNoOpHttpPlugin() {
	await import("./Reflect-XOK_g0hC.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_METADATA_KEY } = await import("./plugin-DAO-jmQb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_DEPENDENCIES_METADATA_KEY } = await import("./dependency-B76E9yRs.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_EVENTS_METADATA_KEY } = await import("./event-BvW-UKiM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-C_TL2KjJ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
