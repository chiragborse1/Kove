...
import { o as resolveCompatibilityHostVersion } from "./version-By7KE3vz.js";
import { f as resolveBundledPluginsDir } from "./bundled-plugin-metadata-BoHf6EFf.js";
import { a as resolvePackageExtensionEntries, i as loadPluginManifest, r as getPackageManifestMetadata, t as DEFAULT_PLUGIN_ENTRY_CANDIDATES } from "./manifest-BypuTSov.js";
import { a as normalizePluginsConfig } from "./config-state-D8pUIUQo.js";
import { a as safeStatSync, i as safeRealpathSync, l as detectBundleManifestFormat, n as formatPosixMode, r as isPathInside, t as checkMinHostVersion, u as loadBundleManifest } from "./min-host-version-BuwanWEb.js";
	...
	for (const candidate of candidates) {
		...
		if (!minHostVersionCheck.ok) {
			...
			diagnostics.push({
				...
				message: minHostVersionCheck.kind === "invalid" ? `plugin manifest invalid | ${minHostVersionCheck.error}` : minHostVersionCheck.kind === "unknown_host_version" ? `plugin requires Kova >=${minHostVersionCheck.requirement.minimumLabel}, but the current Kova version is unavailable in this runtime; skipping load` : `plugin requires Kova >=${minHostVersionCheck.requirement.minimumLabel}, but this host is ${minHostVersionCheck.currentVersion}; skipping load`
			});
			continue;
		}
