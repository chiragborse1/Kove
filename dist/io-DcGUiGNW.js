import { T as resolveRequiredHomeDir, b as expandHomePrefix, l as resolveDefaultConfigCandidates, n as DEFAULT_GATEWAY_PORT, o as resolveCanonicalConfigPath, p as resolveLegacyConfigPathsForCanonicalPath, s as resolveConfigPath, y as resolveStateDir } from "./paths-CG2veZVr.js";
import { O as isPlainObject$2, b as resolveUserPath, f as isRecord } from "./utils-CQHEfYrT.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-OPjrzs9a.js";
import { r as normalizeProviderId } from "./provider-id-CHzLB538.js";
import { n as resolveAgentModelPrimaryValue } from "./model-input-DCGIwELO.js";
import { f as parseModelRef } from "./model-selection-CdS674HX.js";
import { c as normalizeAgentId } from "./session-key-vgS1x1jn.js";
import { t as isBlockedObjectKey } from "./prototype-keys-CzIwZDin.js";
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-PYTdAamx.js";
import { i as normalizeEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName } from "./host-env-security-CSk3FuWM.js";
import { t as loadDotEnv } from "./dotenv-XLj-wSRB.js";
import { a as shouldDeferShellEnvFallback, i as resolveShellEnvFallbackTimeoutMs, o as shouldEnableShellEnvFallback, r as loadShellEnvFallback } from "./shell-env-D9cF1XTP.js";
import { t as sanitizeTerminalText } from "./safe-text--xgippGL.js";
import { n as VERSION } from "./version-By7KE3vz.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-CdsIpf4B.js";
import { a as mergeMissing, i as mapLegacyAudioTranscription, n as ensureRecord, r as getRecord, t as defineLegacyConfigMigration } from "./legacy.shared-DM1hK8cL.js";
import { C as resolveSlackNativeStreaming, S as resolveDiscordPreviewStreamMode, T as resolveTelegramPreviewStreamMode, a as IrcConfigSchema, b as formatSlackStreamingBooleanMigrationMessage, c as SlackConfigSchema, i as IMessageConfigSchema, l as TelegramConfigSchema, n as DiscordConfigSchema, o as MSTeamsConfigSchema, r as GoogleChatConfigSchema, s as SignalConfigSchema, t as BlueBubblesConfigSchema, v as ChannelHeartbeatVisibilitySchema, w as resolveSlackStreamingMode, y as formatSlackStreamModeMigrationMessage } from "./zod-schema.providers-core-BbmGNv_u.js";
import { a as hasConfiguredSecretInput, i as coerceSecretRef } from "./types.secrets-mzCLKGg0.js";
import { A as TtsConfigSchema, I as createAllowDenyChannelRulesSchema, N as TypingModeSchema, O as TranscribeAudioSchema, S as SecretInputSchema, T as SecretsConfigSchema, c as GroupPolicySchema, f as InboundDebounceSchema, g as NativeCommandsSettingSchema, h as ModelsConfigSchema, l as HexColorSchema, n as BlockStreamingCoalesceSchema, r as CliBackendSchema, s as GroupChatSchema, t as BlockStreamingChunkSchema, u as HumanDelaySchema, v as QueueSchema } from "./zod-schema.core-1c4_V7ob.js";
import { t as sensitive } from "./zod-schema.sensitive-Bx_vCfGd.js";
import { i as CHANNEL_IDS, r as normalizeChatChannelId } from "./chat-meta-_mVp3ucX.js";
import "./registry-L-LA-YJT.js";
import { a as BUNDLED_WEB_SEARCH_PLUGIN_IDS$1 } from "./bundled-capability-metadata-CszghHQ6.js";
import { r as hasKind } from "./slots-u5aMXqtV.js";
import { a as normalizePluginsConfig, c as resolveMemorySlotDecision, o as resolveEffectiveEnableState } from "./config-state-D8pUIUQo.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-DYxEn5CL.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-NzxlUGDZ.js";
import { i as summarizeAllowedValues, n as validateJsonSchemaValue, r as appendAllowedValuesHint, t as applyMergePatch } from "./merge-patch-Bv-ypbzf.js";
...
import { a as MemorySearchSchema, c as AgentModelSchema, i as HeartbeatSchema, n as AgentSandboxSchema, r as ElevatedAllowFromSchema, s as ToolsSchema, t as AgentEntrySchema } from "./zod-schema.agent-runtime-0dgF17UR.js";
...
function maybePromoteLegacyConfigToCanonical(deps) {
	if (deps.configPath || deps.env.OPENCLAW_CONFIG_PATH?.trim()) return null;
	const canonicalConfigPath = resolveCanonicalConfigPath(deps.env, resolveStateDir(deps.env, deps.homedir));
	if (deps.fs.existsSync(canonicalConfigPath)) return canonicalConfigPath;
	const legacyConfigPath = resolveLegacyConfigPathsForCanonicalPath(canonicalConfigPath).find((candidate) => deps.fs.existsSync(candidate));
	if (!legacyConfigPath) return null;
	try {
		...
		deps.logger.warn(`Failed to migrate legacy config ${legacyConfigPath} -> ${canonicalConfigPath}: ${String(error)}`);
...
function createConfigIO(overrides = {}) {
	...
	const candidatePaths = deps.configPath ? [requestedConfigPath] : resolveDefaultConfigCandidates(deps.env, deps.homedir);
	const configPath = migratedConfigPath ?? candidatePaths.find((candidate) => deps.fs.existsSync(candidate)) ?? requestedConfigPath;
...
//#endregion
export { buildSafeBinsShellCommand as $, setConfigValueAtPath as A, DEFAULT_SAFE_BINS as At, parseByteSize as B, resolveSubagentMaxConcurrent as Bt, applyConfigOverrides as C, unwrapKnownShellMultiplexerInvocation as Ct, unsetConfigOverride as D, unwrapDispatchWrappersForResolution as Dt, setConfigOverride as E, resolveInlineCommandMatch as Et, validateConfigObjectRaw as F, LEGACY_TALK_PROVIDER_ID as Ft, listWritableExplicitTrustedSafeBinDirs as G, applyLegacyMigrations as Gt, asRuntimeConfig as H, collectPluginSchemaMetadata as Ht, validateConfigObjectRawWithPlugins as I, buildTalkConfigResponse as It, listRiskyConfiguredSafeBins as J, createConfigRuntimeEnv as Jt, normalizeTrustedSafeBinDirs as K, ensureControlUiAllowedOriginsForNonLoopbackBind as Kt, validateConfigObjectWithPlugins as L, normalizeTalkSection as Lt, migrateLegacyConfig as M, normalizeSafeBinProfileFixtures as Mt, collectUnsupportedSecretRefPolicyIssues as N, resolveSafeBinProfiles as Nt, getConfigValueAtPath as O, unwrapKnownDispatchWrapperInvocation as Ot, validateConfigObject as P, resolveNormalizedProviderModelMaxTokens as Pt, buildEnforcedShellCommand as Q, OpenClawSchema as R, resolveActiveTalkProviderConfig as Rt, normalizeOpenClawVersionBase as S, isShellWrapperExecutable as St, resetConfigOverrides as T, POWERSHELL_INLINE_COMMAND_FLAGS as Tt, getTrustedSafeBinDirs as U, GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA as Ut, asResolvedSourceConfig as V, collectChannelSchemaMetadata as Vt, isTrustedSafeBinPath as W, listBundledWebSearchPluginIds as Wt, analyzeArgvCommand as X, containsEnvVarReference as Xt, normalizeSafeBinName as Y, MissingEnvVarError as Yt, analyzeShellCommand as Z, resolveOwnerDisplaySetting as Zt, resetConfigRuntimeState as _, resolveExecWrapperTrustPlan as _t, getRuntimeConfig as a, matchAllowlist as at, setRuntimeConfigSnapshotRefreshHandler as b, extractShellWrapperInlineCommand as bt, loadConfig as c, resolveApprovalAuditCandidatePath as ct, readBestEffortConfig as d, resolveExecutionTargetCandidatePath as dt, buildSafeShellCommand as et, readConfigFileSnapshot as f, resolveExecutionTargetResolution as ft, registerConfigWriteListener as g, resolveExecutableFromPathEnv as gt, readSourceConfigSnapshotForWrite as h, resolvePolicyTargetResolution as ht, createConfigIO as i, splitCommandChainWithOperators as it, unsetConfigValueAtPath as j, SAFE_BIN_PROFILES as jt, parseConfigPath as k, normalizeExecutableToken as kt, parseConfigJson5 as l, resolveCommandResolution as lt, readSourceConfigSnapshot as m, resolvePolicyTargetCandidatePath as mt, clearConfigCache as n, resolvePlannedSegmentArgv as nt, getRuntimeConfigSnapshot as o, parseExecArgvToken as ot, readConfigFileSnapshotForWrite as p, resolvePolicyAllowlistCandidatePath as pt, validateSafeBinArgv as q, collectDurableServiceEnvVars as qt, clearRuntimeConfigSnapshot as r, splitCommandChain as rt, getRuntimeConfigSourceSnapshot as s, resolveAllowlistCandidatePath as st, ConfigRuntimeRefreshError as t, isWindowsPlatform as tt, projectConfigOntoRuntimeSourceSnapshot as u, resolveCommandResolutionFromArgv as ut, resolveConfigSnapshotHash as v, POSIX_SHELL_WRAPPERS as vt, getConfigOverrides as w, POSIX_INLINE_COMMAND_FLAGS as wt, writeConfigFile as x, hasEnvManipulationBeforeShellWrapper as xt, setRuntimeConfigSnapshot as y, extractShellWrapperCommand as yt, parseNonNegativeByteSize as z, resolveAgentMaxConcurrent as zt };
