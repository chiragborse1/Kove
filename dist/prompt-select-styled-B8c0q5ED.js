import { T as resolveRequiredHomeDir, _ as resolveOAuthDir, d as resolveGatewayPort, f as resolveIsNixMode, t as CONFIG_PATH, y as resolveStateDir } from "./paths-CG2veZVr.js";
...
import { o as getResolvedLoggerSettings } from "./logger-Cnt8m3Fg.js";
import { t as isTruthyEnvValue$1 } from "./env-SmWVaXTv.js";
import { C as shortenHomePath, b as resolveUserPath, w as sleep } from "./utils-CQHEfYrT.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-CSVK41Xr.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-CBD_gvpA.js";
...
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-CdS674HX.js";
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-vgS1x1jn.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-PYTdAamx.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-Cdhvx72k.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-CQxvqRkp.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-DBgoItUM.js";
import { Ft as LEGACY_TALK_PROVIDER_ID, J as listRiskyConfiguredSafeBins, K as normalizeTrustedSafeBinDirs, Lt as normalizeTalkSection, M as migrateLegacyConfig, Pt as resolveNormalizedProviderModelMaxTokens, U as getTrustedSafeBinDirs, W as isTrustedSafeBinPath, f as readConfigFileSnapshot, ut as resolveCommandResolutionFromArgv, x as writeConfigFile } from "./io-DcGUiGNW.js";
import { C as resolveSlackNativeStreaming, S as resolveDiscordPreviewStreamMode, T as resolveTelegramPreviewStreamMode, b as formatSlackStreamingBooleanMigrationMessage, w as resolveSlackStreamingMode, y as formatSlackStreamModeMigrationMessage } from "./zod-schema.providers-core-BbmGNv_u.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-mzCLKGg0.js";
import { r as normalizeChatChannelId } from "./chat-meta-_mVp3ucX.js";
import "./registry-L-LA-YJT.js";
import { a as normalizePluginsConfig, i as normalizePluginId, o as resolveEffectiveEnableState } from "./config-state-D8pUIUQo.js";
...
import { d as resolveProfileUnusableUntilForDisplay } from "./order-C7t43F_g.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-BQ3g7NQ6.js";
import { t as formatCliCommand } from "./command-format-Wh1wnuz1.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-Ce1e_DDq.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-C0Y8zcXe.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BC87VeYu.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CI1Fmm6N.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-DrJpXL1g.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-CTrWm98z.js";
import { a as readGatewayTokenEnv } from "./credential-planner-B0vdUPPY.js";
import "./credentials-D-Qn12vP.js";
...
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-4IMxEMRc.js";
import "./plugins-CsZ0NNl7.js";
import { i as resolveMainSessionKey } from "./main-session-Boe1XF3k.js";
import { i as resolveAgentSessionDirs } from "./sessions-Sa--dLyw.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-B2rgdouq.js";
import { r as listPotentialConfiguredChannelIds } from "./config-presence-CUnY3NS1.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-B-0kVuVf.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-DvZddQZR.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-CnclFo7p.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-Cmc_PDdk.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-rmymmP8h.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DCvWupN8.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-BPgzEhsc.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-738lx6X3.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-Cx-dD96U.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-C_gX92o7.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-BBrhj0lW.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-BJqyInLQ.js";
...
import { n as formatConfigIssueLines } from "./issue-format-BI5rIoW9.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-CuZ3K2Az.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-mgUYMjR-.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-Oc44ujw_.js";
import { t as resolvePluginProviders } from "./providers.runtime-BvwU2IuS.js";
import { b as resolveBootstrapContextForRun, g as TrimmedNonEmptyStringFieldSchema, m as LowercaseNonEmptyStringFieldSchema, n as buildBootstrapInjectionStats, p as DeliveryThreadIdFieldSchema, s as inferLegacyName, t as analyzeBootstrapBudget, u as normalizeOptionalText, v as parseOptionalField } from "./bootstrap-budget-B3n0Qxtk.js";
import { H as resolveBootstrapMaxChars, W as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-R1qThM66.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-pDt0KpDN.js";
import { s as resolveApiKeyForProvider } from "./model-auth-CyDzECEz.js";
import { t as migrateLegacyWebSearchConfig } from "./legacy-web-search-BztdBZ6G.js";
import { l as loadExecApprovals } from "./exec-approvals-C-ADQo5x.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-SzvpOAQ1.js";
import "./sandbox-CbS9LA4E.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger--72v8ONr.js";
import { r as loadModelCatalog } from "./model-catalog-a68iwY1h.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DxQmZTJq.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BlPJW81G.js";
import { i as listRouteBindings } from "./bindings-DsEUzN94.js";
import { B as parseBrowserMajorVersion, H as readBrowserVersion, K as resolveGoogleChromeExecutableForPlatform } from "./browser-runtime-DNinsd0O.js";
import { r as resolveActiveMemoryBackendConfig } from "./memory-runtime-BvN9mszl.js";
import { t as resolveMemorySearchConfig } from "./memory-search-C9FPakr-.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-1p2kT41V.js";
import { a as readChannelAllowFromStore } from "./pairing-store-DklV8QCn.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-BBYLu_bL.js";
...
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-D6MtCDFd.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-C1OHwWGt.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DmsHoH5U.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-BslUvb92.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-CjuLKwWr.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-CXzgXETx.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-xca3xA7S.js";
import { t as checkQmdBinaryAvailability } from "./memory-core-host-engine-qmd-DLn3qqnI.js";
import "./memory-core-host-engine-storage-B4yfbpMd.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C0pH3Yqh.js";
import { a as buildPluginStatusReport, r as buildPluginCompatibilityWarnings } from "./status-C60d7mDK.js";
import { t as note$1 } from "./note-MqXwK9Il.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-_T16CoX4.js";
import { r as healthCommand } from "./health-Ctgc6rv9.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-jUFD58KC.js";
import { n as runGatewayUpdate, r as coerceFiniteScheduleNumber, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-CtCLXswv.js";
import { i as normalizeTelegramAllowFromEntry, n as isNumericTelegramUserId, r as listTelegramAccountIds, t as inspectTelegramAccount } from "./read-only-account-inspect.telegram-5PgSkUaR.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-IN5v7Sk0.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-DP2af0VX.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-Dpcaav3l.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BUPFW5dE.js";
import { t as formatHealthCheckFailure } from "./health-format-Bmh-oSqv.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BdL7LHRo.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-DNPExtly.js";
import { n as doctorShellCompletion } from "./doctor-completion-Da5WPQgr.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-TTqeuj6z.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-icwa-erG.js";
import "./doctor-state-migrations-CFMxeD_h.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-Bdc_YwAD.js";
...
function collectExecPolicyConflictWarnings(cfg) {
	...
	const defaultRequestedSecuritySource = "Kova default (allowlist)";
	const defaultRequestedAskSource = "Kova default (on-miss)";
	const maybeWarn = (params) => {
		...
		warnings.push([
			...
			`  Inspect with: ${formatCliCommand("kova approvals get --gateway")}`
		].join("\n"));
	};
	maybeWarn({
...
async function noteSecurityWarnings(cfg) {
	const warnings = [];
	const auditHint = `- Run: ${formatCliCommand("kova security audit --deep")}`;
	if (cfg.approvals?.exec?.enabled === false) warnings.push("- Note: approvals.exec.enabled=false disables approval forwarding only.", "  Host exec gating still comes from ~/.openclaw/exec-approvals.json.", `  Check local policy with: ${formatCliCommand("kova approvals get --gateway")}`);
	...
	if (isExposed) if (!hasSharedSecret) {
		const authFixLines = resolvedAuth.mode === "password" ? [`  Fix: ${formatCliCommand("kova configure")} to set a password`, `  Or switch to token: ${formatCliCommand("kova config set gateway.auth.mode token")}`] : [`  Fix: ${formatCliCommand("kova doctor --fix")} to generate a token`, `  Or set token directly: ${formatCliCommand("kova config set gateway.auth.mode token")}`];
		warnings.push(`- CRITICAL: Gateway bound to ${bindDescriptor} without authentication.`, `  Anyone on your network (or internet if port-forwarded) can fully control your agent.`, `  Fix: ${formatCliCommand("kova config set gateway.bind loopback")}`, ...saferRemoteAccessLines, ...authFixLines);
	...
	const warnDmPolicy = async (params) => {
		...
		if (dmScope === "main" && isMultiUserDm) warnings.push(`- ${params.label} DMs: multiple senders share the main session; run: ` + formatCliCommand("kova config set session.dmScope \"per-channel-peer\"") + " (or \"per-account-channel-peer\" for multi-account channels) to isolate sessions.");
	};
