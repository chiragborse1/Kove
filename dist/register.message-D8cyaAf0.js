...
import { r as normalizeChatChannelId, t as getChatChannelMeta } from "./chat-meta-_mVp3ucX.js";
...
import { o as runGlobalGatewayStopSafely } from "./hook-runner-global-CKoMjNyz.js";
import { n as CHANNEL_TARGET_DESCRIPTION, t as CHANNEL_TARGETS_DESCRIPTION } from "./channel-target-HUp392m0.js";
import { a as formatTargetDisplay, c as resolveMessageSecretScope, l as CHANNEL_MESSAGE_ACTION_NAMES, n as runMessageAction } from "./message-action-runner-dfzCJpWZ.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-DxQmZTJq.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-BlPJW81G.js";
...
import { n as ensurePluginRegistryLoaded } from "./plugin-registry-BKaeYsCl.js";
...
${formatHelpExamples([
		["kova message send --target +15555550123 --message \"Hi\"", "Send a text message."],
		["kova message send --target +15555550123 --message \"Hi\" --media photo.jpg", "Send a message with media."],
		["kova message poll --channel discord --target channel:123 --poll-question \"Snack?\" --poll-option Pizza --poll-option Sushi", "Create a Discord poll."],
		["kova message react --channel discord --target 123 --message-id 456 --emoji \"✅\"", "React to a message."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.kova.ai/cli/message")}`).action(() => {
