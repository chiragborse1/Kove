...
import { i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-DUzcQ8hk.js";
import { _ as createEmptyPluginRegistry, g as setActivePluginRegistry, i as getActivePluginRegistryKey, r as getActivePluginRegistry } from "./runtime-D0EER0KC.js";
import { a as buildPluginLoaderAliasMap, c as resolvePluginRuntimeModulePath, d as shouldPreferNativeJiti, o as buildPluginLoaderJitiOptions } from "./bundled-plugin-metadata-BoHf6EFf.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-u5aMXqtV.js";
import { a as normalizePluginsConfig, c as resolveMemorySlotDecision, o as resolveEffectiveEnableState, t as applyTestPluginDefaults } from "./config-state-D8pUIUQo.js";
import { a as safeStatSync, c as CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH, d as mergeBundlePathLists, f as normalizeBundlePathList, o as CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH, r as isPathInside, s as CODEX_BUNDLE_MANIFEST_RELATIVE_PATH } from "./min-host-version-BuwanWEb.js";
import { a as resolvePluginCacheInputs, i as discoverOpenClawPlugins, n as loadPluginManifestRegistry } from "./manifest-registry-NzxlUGDZ.js";
import { n as validateJsonSchemaValue, t as applyMergePatch } from "./merge-patch-Bv-ypbzf.js";
import { t as isChannelConfigured } from "./channel-configured-CFbbwHn_.js";
import { t as buildPluginApi } from "./api-builder-Cp2Cc_Lo.js";
import { a as isPluginHookName, d as validatePluginCommandDefinition, f as clearPluginInteractiveHandlers, g as clearPluginCommands, h as registerPluginInteractiveHandler, l as registerPluginCommand, o as isPromptInjectionHookName, s as stripPromptMutationFieldsFromLegacyHookResult } from "./types-CWq78BqM.js";
import { i as initializeGlobalHookRunner } from "./hook-runner-global-CKoMjNyz.js";
import { a as registerMemoryEmbeddingProvider, i as listRegisteredMemoryEmbeddingProviders, n as getRegisteredMemoryEmbeddingProvider, o as restoreRegisteredMemoryEmbeddingProviders } from "./memory-embedding-providers-DEBAX0cK.js";
import { a as getMemoryRuntime, c as registerMemoryPromptSection, d as restoreMemoryPluginState, i as getMemoryPromptSectionBuilder, l as registerMemoryRuntime, n as clearMemoryPluginState, r as getMemoryFlushPlanResolver, s as registerMemoryFlushPlanResolver } from "./memory-state-Sm982BGU.js";
import { n as registerContextEngineForOwner } from "./registry-B4eMDTCN.js";
import { f as registerInternalHook } from "./internal-hooks-DRuWmhD8.js";
import { a as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-Dd7h4iNq.js";
...
function loadOpenClawPlugins(options = {}) {
	...
	for (const candidate of orderedCandidates) {
		...
		const shouldUseSetupRuntime = !validateOnly && shouldLoadChannelPluginInSetupRuntime({
		...
		const canUseSelectedSetupRuntime = shouldUseSetupRuntime && onlyPluginIdSet?.has(pluginId) && (enableState.reason === "bundled (disabled by default)" || enableState.reason === "not in allowlist");
		const registrationMode = enableState.enabled ? shouldUseSetupRuntime ? "setup-runtime" : "full" : canUseSelectedSetupRuntime ? "setup-runtime" : includeSetupOnlyChannelPlugins && !validateOnly && onlyPluginIdSet && manifestRecord.channels.length > 0 ? "setup-only" : null;
		if (!registrationMode) {
			record.status = "disabled";
